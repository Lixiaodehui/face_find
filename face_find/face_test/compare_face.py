...
class face_recognition(object):
    def __init__(self):
        ...
        self.predictor_path = self.current_path + "\\shape_predictor_68_face_landmarks.dat"
        self.face_rec_model_path = self.current_path + "\\dlib_face_recognition_resnet_model_v1.dat"
        self.faces_folder_path = self.current_path + "\\test\\"
    ...
    def inputPerson2(self, name='people', img_bgr=None):
        # if img_bgr == None:
        #     print('No file!\n')
        #     return
